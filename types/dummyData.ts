    ...
    blocks: [
      {
        blockName: 'A Block',
        blockParticipants: [
          { name: 'Zack Sabre Jr.', id: 'A0' },
          { name: 'Evil', id: 'A1' },
          { name: 'Shingo Takagi', id: 'A2' },
          { name: 'Gabe Kidd', id: 'A3' },
          { name: 'Tetsuya Naito', id: 'A4' },
          { name: 'Jake Lee', id: 'A5' },
          { name: 'Sanada', id: 'A6' },
          { name: 'Callum Newman', id: 'A7' },
          { name: 'Shota Umino', id: 'A8' },
          { name: 'Great-O-Khan', id: 'A9' },
        ],
      },
      {
        blockName: 'B Block',
        blockParticipants: [
          { name: 'Yuya Uemura', id: 'B0' },
          { name: 'Henare', id: 'B1' },
          { name: 'Konosuke Takeshita', id: 'B2' },
          { name: 'Ren Narita', id: 'B3' },
          { name: 'Hirooki Goto', id: 'B4' },
          { name: 'Boltin Oleg', id: 'B5' },
          { name: 'Jeff Cobb', id: 'B6' },
          { name: 'El Phantasmo', id: 'B7' },
          { name: 'Yota Tsuji', id: 'B8' },
          { name: 'David Finlay', id: 'B9' },
        ],
      },
    ],
  },
